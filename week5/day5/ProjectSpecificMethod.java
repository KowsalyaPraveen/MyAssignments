...
public class ProjectSpecificMethod {
	...
	public void preCondition(String uname,String pword, String appUrl,String executionEnv) { // Same order in the pipeline should be maintained here
		...
		System.out.println("@BeforeMethod  from ProjectSpecificMethod.preCondition");
	}
	@AfterMethod
	public void postCondition() {
		System.out.println("@AfterMethod  from ProjectSpecificMethod.postCondition");
		driver.quit();
	}
	
	@DataProvider(name = "extractData")
	public String[][] dataLibrary() throws IOException {
		System.out.println("@DataProvider from ProjectSpecificMethod.dataLibrary");
